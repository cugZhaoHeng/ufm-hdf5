...
def animate_sequential_growth_fixed(file_path):
    ...
    ani = FuncAnimation(fig, update, frames=len(frames_map), interval=30, blit=False)
...
if __name__ == "__main__":
    target = r"C:\Users\xiangdongliu\Desktop\Kinetixmodel\import_data\JY68-4HF\JY68-4HF.h5"
